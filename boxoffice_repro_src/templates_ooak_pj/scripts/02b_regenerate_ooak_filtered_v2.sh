#!/usr/bin/env bash
# Phase 2 (OOAK) — build the one-of-a-kind filtered-v2 joint shared seeds.
# Calls experiments/v2_filtered/run_ooak_joint_filtered_probe.sh, which uses
...
OUT_ROOT="${OUT_ROOT:-${TPL_ROOT}/regenerated/ooak_filtered_v2_joint_probe_${TS}}"
...
bash "${TPL_ROOT}/experiments/v2_filtered/run_ooak_joint_filtered_probe.sh"
